...
const userFields = `
  ...
  pending_withdrawal_asset AS "pendingWithdrawalAsset",
  pending_withdrawal_network AS "pendingWithdrawalNetwork",
  pending_withdrawal_address AS "pendingWithdrawalAddress",
  pending_withdrawal_status AS "pendingWithdrawalStatus",
  pending_withdrawal_note AS "pendingWithdrawalNote",
  pending_withdrawal_reviewed_by AS "pendingWithdrawalReviewedBy",
  pending_withdrawal_reviewed_at AS "pendingWithdrawalReviewedAt",
  pending_withdrawal_submitted_at AS "pendingWithdrawalSubmittedAt",
  is_admin AS "isAdmin",
